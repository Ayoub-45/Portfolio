          ...
          <div className="ag-courses_box">
            <div className="ag-courses_item">
              <div className="ag-courses-item_link">
                ...
                <div class="ag-courses-item_title">Writing&#160;</div>
                <div class="ag-courses-item_date-box">
                  Started:
                  <span class="ag-courses-item_date">01.06.2018</span>
                </div>
              </div>
            </div>
            <div className="ag-courses_item">
            ...
            <div className="ag-courses_item">
              <div className="ag-courses-item_link">
                ...
                <div class="ag-courses-item_date-box">
                  Started:
                  <span class="ag-courses-item_date">01.07.2021</span>
                </div>
              </div>
            </div>
            <div className="ag-courses_item">
              <div className="ag-courses-item_link">
                ...
                <div class="ag-courses-item_date-box">
                  Started:
                  <span class="ag-courses-item_date">05.07.2023</span>
                </div>
              </div>
            </div>
            <div className="ag-courses_item">
